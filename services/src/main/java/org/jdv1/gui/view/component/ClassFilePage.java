...
public class ClassFilePage extends TypePage {
    ...
    protected org.jdv0.gui.view.component.ClassFilePage v0Page;
    ...
    public void decompile(Map<String, String> preferences) {
        try {
            ...
            assert ExceptionUtil.printStackTrace(t);
            v0Page = new org.jdv0.gui.view.component.ClassFilePage(api, entry);
            lineNumberMap = v0Page.getLineNumberMap();
            maxLineNumber = v0Page.getMaximumLineNumber();
            setText(v0Page.getText());
        }

		maximumLineNumber = Math.max(getMaximumLineNumber(), v0Page.getMaximumLineNumber());
    }
