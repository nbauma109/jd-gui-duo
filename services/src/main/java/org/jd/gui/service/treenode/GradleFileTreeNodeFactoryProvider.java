...
public class GradleFileTreeNodeFactoryProvider extends TextFileTreeNodeFactoryProvider {

    protected static final ImageIcon ICON = new ImageIcon(ImageUtil.getImage("/org/jd/gui/images/gradle_file.png"));

    @Override
    public String[] getSelectors() {
        return appendSelectors("*:file:build.gradle");
    }
