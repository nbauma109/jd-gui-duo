...
public class BatFileTreeNodeFactoryProvider extends TextFileTreeNodeFactoryProvider {

    protected static final ImageIcon ICON = new ImageIcon(ImageUtil.getImage("/org/jd/gui/images/bat.png"));

    @Override
    public String[] getSelectors() {
        return appendSelectors("*:file:*.bat");
    }
