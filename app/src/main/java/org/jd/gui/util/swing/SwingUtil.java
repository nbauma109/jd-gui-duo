...
public class SwingUtil {
	...
	/**
	 * Swing menus are looking pretty bad on Linux when the GTK LaF is used (See bug
	 * #6925412). It will most likely never be fixed anytime soon so this method
	...
	/**
	 * Called internally by installGtkPopupBugWorkaround to fix the thickness of a
	 * GTK style field by setting it to a minimum value of 1.
	 *
